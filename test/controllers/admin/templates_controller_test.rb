...
class Admin::TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_template" do
    assert_difference('Admin::Template.count') do
      post admin_templates_url, params: { admin_template: { logo: @admin_template.logo, name: @admin_template.name, slug: @admin_template.slug, view_article: @admin_template.view_article } }
    end
  ...
  test "should update admin_template" do
    patch admin_template_url(@admin_template), params: { admin_template: { logo: @admin_template.logo, name: @admin_template.name, slug: @admin_template.slug, view_article: @admin_template.view_article } }
